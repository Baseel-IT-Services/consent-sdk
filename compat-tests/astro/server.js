// Minimal mock backend for the Astro compat test.
// Node built-in http only, no Express. Serves mock API endpoints on port 4793
// with CORS headers so the Astro preview server (a different port) can call it.
